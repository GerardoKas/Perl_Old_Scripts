#Colorea la sintaxis de un batch y genera una pagina HTML
@COMS=qw(if errorlevel title echo off cls pause goto start exit set);#Se le pueden añadir mas comandos
